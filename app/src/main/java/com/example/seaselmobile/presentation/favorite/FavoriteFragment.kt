package com.example.seaselmobile.presentation.favorite
...
@AndroidEntryPoint
class FavoriteFragment : Fragment(R.layout.fragment_faivorite) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val musicListRecycler = view.findViewById<RecyclerView>(R.id.favoriteRecycler)
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            viewModel.events.flowWithLifecycle(viewLifecycleOwner.lifecycle).collectLatest {
                when (it) {
                    ...
                    is FavoriteViewModel.Event.ToFeedback -> {
