        ...
        for (it in takts.indices) {
            for (note in takts[it].notes) {
                ...
                for (number in note.notes) {
                    if (left + noteWidth / 2 - time * taktLength < center + noteWidth && left + noteWidth / 2 - time * taktLength > center) {
                    ...
                    } else if (left + noteWidth / 2 - time * taktLength < center && note.accuracy == 0) {
                        note.accuracy--
                    }
